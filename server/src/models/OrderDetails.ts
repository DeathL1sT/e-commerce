...
export default class Orders{
    index=async():Promise<OrderSchema[]>=>{
        try{
    ...
    show =async (id:string):Promise<OrderSchema> => {
        try{
            const con = await client.connect()
    ...
    create =async (o:OrderSchema):Promise<OrderSchema> => {
        try{
            const con = await client.connect()
    ...
    update =async (id:string,o:OrderSchema):Promise<OrderSchema> => {
        try{
            const con = await client.connect()
    ...
    delete =async (id:string):Promise<OrderSchema> => {
        try{
            const con = await client.connect()
