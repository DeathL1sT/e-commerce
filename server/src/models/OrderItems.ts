...
export default class OrderItem{
    index=async():Promise<OrderItemSchema[]>=>{
        try{
    ...
    show =async (id:string):Promise<OrderItemSchema> => {
        try{
            const con = await client.connect()
    ...
    create =async (o:OrderItemSchema):Promise<OrderItemSchema> => {
        try{
            const con = await client.connect()
    ...
    update =async (id:string,o:OrderItemSchema):Promise<OrderItemSchema> => {
        try{
            const con = await client.connect()
    ...
    delete =async (id:string):Promise<OrderItemSchema> => {
        try{
            const con = await client.connect()
